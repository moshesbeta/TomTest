...
from Belief_R.prompts import build_prompt
from Belief_R.metrics import compute_metrics, get_gold_label


def main():
    # 加载数据集配置
    dataset_config = runner.load_dataset_config("tasks/Belief_R/config.yaml")
