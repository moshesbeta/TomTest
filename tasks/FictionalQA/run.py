...
from FictionalQA.prompts import build_prompt
from FictionalQA.metrics import compute_metrics, get_gold_label


def main():
    # 加载数据集配置
    dataset_config = runner.load_dataset_config("tasks/FictionalQA/config.yaml")
    ...
    # 提前准备 gold_answers
    gold_answers = [get_gold_label(row) for row in data]
